...
\section*{Project 2, Schr\"odinger's equation for two electrons in a three-dimensional harmonic oscillator well, deadline   October   7 (noon)}
...
eigenvalue problems. You should then try to find the function which obtains the eigenvalues of a tridiagonal matrix. 
...
For specific oscillator frequencies, the above equation has answers in closed form,
...
\item[e)]  This exercise is optional (frivillig) and is meant more as a challenge. 
Implement the iterative Lanczos' algorithm discussed in the lectures and compute the lowest eigenvalues 
